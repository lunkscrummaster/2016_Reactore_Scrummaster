  ...
  */
  ...
  switch (state = newState) {
    ...
    case UIS_SCRUM_STRENGTH:
      ...
      lcd.setCursor(2, 2);  lcd.print("Difficulty:"); // TRUCK possible "y" on lcd?
...
void UISystem::goStrengthPosthit(byte SPH_code, int val) {
  ...
  switch (SPH_code) {
    case UISPH_TOO_HIGH:    break;
    case UISPH_TOO_FAST:    break;
    case UISPH_TOO_MUCH:    break;
    case UISPH_SUCCESS:     break;
    default:
      break;
  }
